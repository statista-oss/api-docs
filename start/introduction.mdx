...
<CardGroup cols={2}>
  ...
  <Card title="Get started with MCP Server" icon="robot" href="/mcp-server/introduction">
    Integrate Statista data into Claude, Gemini and OpenAI
  </Card>
    <Card title="Explore prompt library" icon="file" href="/prompt-library/statista-researcher">
