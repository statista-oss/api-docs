...
<img className="block dark:hidden w-52 h-auto" src="/images/statista-logo.png" alt="Hero Light" />
<img className="hidden dark:block w-52 h-auto" src="/images/statista-logo.png" alt="Hero Dark" />
...
<CardGroup cols={2}>
  <Card title="Playground" icon="rocket" href="/api-reference/discovery-starter/get-statistics">
